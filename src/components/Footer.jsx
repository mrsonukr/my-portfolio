...
const Footer = () => {
  ...
  return (
    <footer className="w-full bg-black flex flex-col p-8">
      <ul className="social-m">
        {socialLinks.map((social, index) => (
          <li key={index} className="icon-content">
            <a data-social={social.name} aria-label={social.name} href={social.url}>
      ...
      <p className="copyright text-[#ececec8e] text-center leading-[3]">
